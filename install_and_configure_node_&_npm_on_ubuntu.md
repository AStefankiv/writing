...
![node_npm_ubuntu](media/node_npm_ubuntu.png) <!-- for local env-->
![node_npm_ubuntu](https://github.com/AStefankiv/writing/blob/main/media/node_npm_ubuntu.png) <!-- for GitHub -->
